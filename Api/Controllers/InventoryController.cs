...
{
    public InventoryController(Exchange exchange, IMediaSearch mediaSearch) 
    ...
    // Add staff-specific operations here
    // [HttpPut("{id}")]
    // public async Task<ActionResult> Update(string id, [FromBody] MediaUpdateModel model)
    // {
    //     // Staff-only update logic
    //     return Ok();
    // }
}